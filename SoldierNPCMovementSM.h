...
//struct SoldierNPCMovementSM_Event_AIM_AT_TARGET : public PE::Events::Event {
//	PE_DECLARE_CLASS(SoldierNPCMovementSM_Event_AIM_AT_TARGET);
//
//	SoldierNPCMovementSM_Event_AIM_AT_TARGET(Vector3 targetPos = Vector3());
//
//	Vector3 m_targetPosition;
//};
...
struct SoldierNPCMovementSM : public PE::Components::Component
{
	...
	//
	//PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SoldierNPCMovementSM_Event_AIM_AT_TARGET)
	//	virtual void do_SoldierNPCMovementSM_Event_AIM_AT_TARGET(PE::Events::Event* pEvt);
